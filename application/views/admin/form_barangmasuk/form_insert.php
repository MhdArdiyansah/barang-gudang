                  ...
                  <form action="<?= base_url('admin/proses_databarang_masuk_insert') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control" readonly="readonly" value="ES-<?= date("Y"); ?><?= random_string('numeric', 8); ?>">
                      </div>
                      </div>
                      <div class="form-group">
