<br><br><br>
    ...
    <h2 class="tex-center">Tabel Compound Keluar</h2>
    ...
    <table class="table table-bordered table-striped" style="margin: 2em auto;" id="tabel_compoundkeluar">
    <thead>
      <tr>
        <th>No</th>
        <th>ID_Transaksi</th>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#tabel_compoundkeluar').DataTable();
  });
</script>
