<br><br><br>
    ...
    <h2 class="tex-center">Tabel Wafer Keluar</h2>
    ...
    <table class="table table-bordered table-striped" style="margin: 2em auto;" id="tabel_waferkeluar">
    <thead>
      <tr>
        <th>No</th>
        <th>ID_Transaksi</th>
