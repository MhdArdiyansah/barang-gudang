     ...
     <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url('user/tabel_barangmasuk') ?>"><i class="fa fa-caret-right"></i> Tabel Barang Masuk</a></li>
              <li><a href="<?= base_url('user/tabel_barangkeluar') ?>"><i class="fa fa-caret-right"></i> Tabel Barang Keluar</a></li>
              <li><a href="<?= base_url('user/tabel_satuan') ?>"><i class="fa fa-caret-right"></i> Tabel Satuan</a></li>
              <li><a href="<?= base_url('user/tabel_compoundmasuk') ?>"><i class="fa fa-caret-right"></i> Stock Compound</a></li>
              <li><a href="<?= base_url('user/tabel_leadframemasuk') ?>"><i class="fa fa-caret-right"></i> Stock Leadframe</a></li>
              <li><a href="<?= base_url('user/tabel_gluemasuk') ?>"><i class="fa fa-caret-right"></i> Stock Glue</a></li>
              <li><a href="<?= base_url('user/tabel_wafermasuk') ?>"><i class="fa fa-caret-right"></i> Stock Wafer</a></li>
              <li><a href="<?= base_url('user/tabel_solderwiremasuk') ?>"><i class="fa fa-caret-right"></i> Stock Solder Wire</a></li>
              <li><a href="<?= base_url('user/tabel_wireaum') ?>"><i class="fa fa-caret-right"></i> Stock Wire Au</a></li>
              <li><a href="<?= base_url('user/tabel_wirecumasuk') ?>"><i class="fa fa-caret-right"></i> Stock Wire Cu</a></li>
              <li><a href="<?= base_url('user/tabel_wirealumasuk') ?>"><i class="fa fa-caret-right"></i> Stock Wire Alu</a></li>
              <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
            <li><a href="<?= base_url('user/') ?>"><i class="fa fa-circle-o"></i> Before DMC</a></li>
            <li><a href="<?= base_url('user') ?>"><i class="fa fa-circle-o"></i> After DMC</a></li>
            </ul>
            </ul>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('user/tabel_compoundkeluar') ?>"><i class="fa fa-caret-right"></i> Out Compound</a></li>
              <li><a href="<?php echo base_url('user/tabel_leadframekeluar') ?>"><i class="fa fa-caret-right"></i> Out Leadframe</a></li>
              <li><a href="<?php echo base_url('user/tabel_gluekeluar') ?>"><i class="fa fa-caret-right"></i> Out Glue</a></li>
              <li><a href="<?php echo base_url('user/tabel_waferkeluar') ?>"><i class="fa fa-caret-right"></i> Out Wafer</a></li>
              <li><a href="<?php echo base_url('user/tabel_solderwirekeluar') ?>"><i class="fa fa-caret-right"></i> Out Solder Wire</a></li>
              <li><a href="<?php echo base_url('user/tabel_wireauk') ?>"><i class="fa fa-caret-right"></i> Out Wire Au</a></li>
              <li><a href="<?php echo base_url('user/tabel_wirecukeluar') ?>"><i class="fa fa-caret-right"></i> Out Wire Cu</a></li>
              <li><a href="<?php echo base_url('user/tabel_wirealukeluar') ?>"><i class="fa fa-caret-right"></i> Out Wire Alu</a></li>
            </ul>
          </li>
          <li>
            <a href="<?php echo base_url('user/profile') ?>">
              <i class="fa fa-cogs" aria-hidden="true"></i> <span>Request</span></a>
          </li>
          <li>
            <a href="<?php echo base_url('user/profile') ?>">
...
<!-- Content Wrapper. Contains page content -->
        ...
        <div class="row">
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-gray">
              ...
              <a href="<?= base_url('user/tabel_compoundmasuk') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-gray">
              ...
              <a href="<?= base_url('user/tabel_leadframemasuk') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-gray">
              <div class="inner">
                <?php if (!empty($stokCompoundKeluar)) { ?>
                  <?php foreach ($stokCompoundKeluar as $d) { ?>
                    <h3><?= $d->jumlah ?></h3>
                  <?php } ?>
                <?php } else { ?>
                  <h3>0</h3>
                ...
                <?php } ?>
                <p>Stok compound Keluar</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="<?= base_url('user/tabel_compoundkeluar') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-gray">
              ...
              <a href="<?= base_url('user/tabel_barangkeluar') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
    ...
    <footer class="main-footer">
      ...
      <strong>ESVENTORY &copy; <?= date('Y') ?></strong>
    </footer>
