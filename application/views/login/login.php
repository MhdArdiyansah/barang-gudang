...
<body>
  ...
  <form action="<?php echo base_url('login/proses_login')?>" class="login" method="post">
    ...
    <p><img src="user_guide/_images/engineering.png" width="280"></p>
    ...
    <button>
      <!-- <i class="spinner"></i> -->
      <span class="state"><i aria-hidden="true"></i> Login</span>
    </button>
  </form>
    <div class="text-center">
      <a class="small" href="<?= base_url('register/forgot') ?>">Forgot Password?</a>
        </div>
