...
class Report extends CI_Controller
{
  ...
  public function compoundKeluarManual()
  {
    ...
    // document informasi
    $pdf->SetCreator('Web Aplikasi Gudang');
    $pdf->SetTitle('Laporan Data compound Keluar');
    $pdf->SetSubject('compound Keluar');

    //header Data
    $pdf->SetHeaderData('unsada.jpg',30,'Laporan Data','compound Keluar',array(203, 58, 44),array(0, 0, 0));
    $pdf->SetFooterData(array(255, 255, 255), array(255, 255, 255));
    ...
    $html=
      '<div>
        ...
        <table border="1">
          <tr>
            <th style="width:40px" align="center">No</th>
            <th style="width:110px" align="center">id_supplier</th>
            <th style="width:110px" align="center">material</th>
            <th style="width:110px" align="center">pellet</th>
            <th style="width:130px" align="center">partno</th>
            <th style="width:140px" align="center">receivedate</th>
            <th style="width:140px" align="center">lotnumber</th>
            <th style="width:80px" align="center">mfgdate</th>
            <th style="width:140px" align="center">Exp Date</th>
            <th style="width:80px" align="center">Stock</th>
            <th style="width:80px" align="center">Jumlah</th>
            <th style="width:80px" align="center">Balance</th>
            <th style="width:140px" align="center">Remarks</th>
          </tr>';
  ...
  public function compoundKeluar()
  {
    $id = $this->uri->segment(3);
    $tgl1 = $this->uri->segment(4);
    $tgl2 = $this->uri->segment(5);
    $tgl3 = $this->uri->segment(6);
    $ls   = array('id_supplier' => $id ,'mfgdate' => $tgl1.'/'.$tgl2.'/'.$tgl3);
    $data = $this->M_admin->get_data('tb_compound_keluar',$ls);
      ...
      '<div>
        ...
        <table border="1">
          ...
          foreach($data as $d){
            $html .= '<tr>';
            $html .= '<td align="center">'.$no.'</td>';
            $html .= '<td align="center">'.$d->id_supplier.'</td>';
            $html .= '<td align="center">'.$d->material.'</td>';
            $html .= '<td align="center">'.$d->pellet.'</td>';
            $html .= '<td align="center">'.$d->partno.'</td>';
            $html .= '<td align="center">'.$d->receivedate.'</td>';
            $html .= '<td align="center">'.$d->lotnumber.'</td>';
            $html .= '<td align="center">'.$d->mfgdate.'</td>';
            $html .= '<td align="center">'.$d->expdate.'</td>';
            $html .= '<td align="center">'.$d->stock.'</td>';
            $html .= '<td align="center">'.$d->jumlah.'</td>';
            $html .= '<td align="center">'.$d->balance.'</td>';
            $html .= '<td align="center">'.$d->remarks.'</td>';
            $html .= '</tr>';
    ...
    $pdf->Output('invoice_compound_keluar.pdf','I');
